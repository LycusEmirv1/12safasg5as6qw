...
client.on("message", message => {
    ...
    const kufur = ["amk","piç","yarrak","ananı sikim","orospu","orospu çoçuğu","siktir git","siktir","anneni sikerim","anneni sikim","amına koduğum","amına koyduğum","gavat","sikik","sikem","kahpe"]
...
client.on("message", async message => {
  var user = message.mentions.users.first() || message.author;
    if (message.content.toLowerCase() === prefix + "atatürkefekt") {		
        var user = message.mentions.users.first() || message.author;
...
client.on('guildMemberAdd', member => {
  ...
  if (!channel) return;
  member.sendMessage('Hozikman sunucusuna hoşgeldin kardeşim.Sunucumuzda #bilgi-kurallar kısmını okumayı unutmayınız. Youtube Kanalımıza hâlâ abone değilsen https://www.youtube.com/hozikman ne duruyorsun')
...
const commands = {
	'play': (msg) => {
		if (queue[msg.guild.id] === undefined) return msg.channel.sendMessage(`${ayarlar.prefix}ekle <url> veya ismi ile birkaç müzik ekle`);
