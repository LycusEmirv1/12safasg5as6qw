...
exports.run = (client, message, args) => {
  ...
  let modlog = guild.channels.find('name', 'uyarı-alanlar');
  if (!modlog) return message.reply('`uyarı-alanlar` kanalını bulamıyorum.');
  ...
  .addField('Kullanıcı:', `${user}#${user.discriminator}`)
...
exports.help = {
  name: 'uyar',
  description: 'İstediğiniz kişiyi uyarır.| Yetkili Komutu |',
